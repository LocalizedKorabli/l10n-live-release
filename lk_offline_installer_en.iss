#define MyAppName "LK Localization Offline Pack"
...
[Files]
Source: "Localizations\en\*"; DestDir: "{tmp}\mods"; Flags: ignoreversion recursesubdirs createallsubdirs
